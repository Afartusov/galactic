...
<body>
  ...
  <main class="articleMain">
    <p class="navigation"><a href="/index.php">Главная</a> &nbsp;/ <span
        class="navigationSection"><?= $article['title'] ?></span></p>
    <header>
    ...
    <div class="articleAndImg">
      <article class="currentArticle">
        <time
          datetime="<?= date("d-m-Y", strtotime($article['date'])); ?>"><?= date("d.m.Y", strtotime($article['date'])); ?></time>
